...
namespace Application.Features.ProgrammingTechnologies.Commands.UpdateProgrammingTechnology
{
    public class UpdateProgrammingTechnologyCommand : IRequest<UpdatedProgrammingTechnologyDto>
    {
        ...
        public class UpdateProgrammingTechnologyCommandHandler : IRequestHandler<UpdateProgrammingTechnologyCommand, UpdatedProgrammingTechnologyDto>
        {
            ...
            {
                ProgrammingTechnology? programmingTechnology = await _programmingTechnologyRepository.GetAsync(t => t.Id == request.Id, enableTracking: false);

                _programmingTechnologyBusinessRules.TechnologyShouldExistWhenRequested(programmingTechnology);
                await _programmingTechnologyBusinessRules.TechnologyNameCanNotBeDuplicatedWhenUpdated(request.Id, request.Name);
